...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CollectionFavoris::class, mappedBy="user")
     */
    ...
    {
        if ($this->collectionFavoris->removeElement($collectionFavori)) {
            // set the owning side to null (unless already changed)
            if ($collectionFavori->getUser() === $this) {
                $collectionFavori->setUser(null);
            }
        }
